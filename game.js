...
function beginBattle(kind){
 ...
 const enemies={droid:{name:'ALLIANCE SENTRY',hp:78},scales:{name:'SCALES · THE KING’S RIGHT HAND',hp:138},b2:{name:'B2 HEAVY SENTRY',hp:140},b2captain:{name:'B2 COMMANDER · BULWARK',hp:205},burrowdroid:{name:'CORPORATE DRILL SENTRY',hp:176},scalesdeep:{name:'SCALES · TUNNEL COMMANDER',hp:242},polarcaptain:{name:'CORPORATE POLAR CAPTAIN',hp:208},cobrisking:{name:'COBRIS · SIX-HEADED SNAKE KING',hp:286}};
...
function enemyTurn(){
 ...
 const enemyLine=isB2?(heavy?'The B2 fires its charged arm cannon. ':'The B2 fires a wrist-blaster burst. '):e.kind==='droid'?'The sentry swings its clanking arm. ':e.kind==='burrowdroid'?(heavy?'The Drill Sentry slams its auger into the tunnel wall. ':'The Drill Sentry sprays stone shards. '):e.kind==='scalesdeep'?(heavy?'Scales whips a crushing tail arc through the chamber. ':'Scales lunges with his silver saber. '):e.kind==='polarcaptain'?(heavy?'The Polar Captain crashes forward with an ice maul. ':'The Polar Captain fires a burst of frozen shards. '):e.kind==='cobrisking'?(heavy?'Cobris roars in six voices and hammers the floor with coiled force. ':'Cobris snaps forward with twin fangs. '):e.turn%3===0?'Scales lashes out with his tail. ':'Scales strikes with his silver saber. ';
